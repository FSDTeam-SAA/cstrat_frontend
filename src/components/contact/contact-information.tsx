  ...
  return (
    <div className="bg-[#323232] rounded-2xl lg:w-[570px] lg:h-[946px] h-[550px] flex flex-col justify-center items-center mx-auto">
      <div className="w-[80%] text-center">
        ...
        <div className="bg-white  h-[96px] px-11 py-6 rounded-md mt-14 flex justify-center items-center">
      ...
      <div className="w-[80%] mt-8 ">
        <Button className="bg-white hover:bg-slate-200 text-black w-full"><a href="https://forms.monday.com/forms/2bcd42c761aa6898d7cb39b2bcab53b7?r=use1" target='_blank'>Intake Form</a></Button>
      </div>
    </div>
  );
}
